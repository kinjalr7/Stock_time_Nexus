...
const ChatbotDemo: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 dark:from-slate-900 dark:via-slate-800 dark:to-blue-900/20 text-gray-900 dark:text-white transition-colors pt-16">
      ...
      {/* Features Section */}
      <div className="py-20 bg-white/50 dark:bg-slate-850/50 backdrop-blur-sm border-t border-b border-gray-100 dark:border-slate-700/50 transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">1. Ask a Question</h3>
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">2. AI Processing</h3>
              <p className="text-gray-600 dark:text-gray-300">
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">3. Get Response</h3>
              <p className="text-gray-600 dark:text-gray-300">
